...
TrapezoidalProfile::TrapezoidalProfile(double max_vel, double max_acc, double time_step) {
...
std::vector<std::vector <double>> TrapezoidalProfile::CreateProfile(double init_pos, double ref) {
